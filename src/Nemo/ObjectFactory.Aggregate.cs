...
public static partial class ObjectFactory
{
    ...
    public static int Count<T>(Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
        where T : class
    {
        return Count<T, int>(predicate, connectionName, connection, config);
    }

    public static long LongCount<T>(Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
       where T : class
    {
        return Count<T, long>(predicate, connectionName, connection, config);
    }

    internal static TResult Count<T, TResult>(Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
        where T : class
    ...
    public static TResult Min<T, TResult>(Expression<Func<T, TResult>> projection, Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
       where T : class
       where TResult : struct
    {
    ...
    public static TResult Sum<T, TResult>(Expression<Func<T, TResult>> projection, Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
       where T : class
       where TResult : struct
    {
    ...
    public static TResult Average<T, TResult>(Expression<Func<T, TResult>> projection, Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
       where T : class
       where TResult : struct
    {
    ...
    internal static TResult Aggregate<T, TResult>(AggregateNames aggregateName, Expression<Func<T, TResult>> projection, Expression<Func<T, bool>> predicate = null, string connectionName = null, DbConnection connection = null, INemoConfiguration config = null)
       where T : class
       where TResult : struct
    {
        string providerName = null;
